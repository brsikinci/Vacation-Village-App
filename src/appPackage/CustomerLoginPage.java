...
public class CustomerLoginPage extends JFrame {
	...
	private CustomerLoginEventHandler handler;
	...
	public CustomerLoginPage() {
		...
		handler = new CustomerLoginEventHandler();
	...
	public class CustomerLoginEventHandler implements ActionListener {
		public void actionPerformed(ActionEvent event) 
		{
			try {
				if (event.getSource() == signInButton) {
					if(database.connectionSuccessful()) {
						if(database.userExists(usernameTextField.getText(), PersonToBeAdded.CUSTOMER)) {
							if(passwordTextField.getText().equals(database.getPassword(usernameTextField.getText(), PersonToBeAdded.CUSTOMER))) {
								customerHomepage.setVisible(true);
								customerHomepage.setContactPhone(usernameTextField.getText());
							}
